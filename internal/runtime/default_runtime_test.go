...
import (
	...
	"gitlab.com/neohet/matrix/internal/parser"
	"gitlab.com/neohet/matrix/internal/scheduler"
...
func TestRuntime_Execute_LogFunc(t *testing.T) {
	...
	msg := types.NewMsg("TEST_MSG", `{"key":"value"}`, types.Metadata{"source": "test"}, nil).WithDataFormat(types.JSON)
...
func TestRuntime_ExecuteAndWait_LogFunc(t *testing.T) {
	...
	msg := types.NewMsg("TEST_MSG_SYNC", `{"key":"sync"}`, types.Metadata{"source": "test_sync"}, nil).WithDataFormat(types.JSON)
...
func TestRuntime_Reload(t *testing.T) {
	...
	{
		"metadata": {
			"nodes": [{"id": "log_v1", "type": "functions", "configuration": {"functionName": "log", "script": "'version 1'"}}]
		}
	}`
	...
	msg := types.NewMsg("TEST_RELOAD", "{}", nil, nil).WithDataFormat(types.JSON)
	...
	{
		"metadata": {
			"nodes": [{"id": "log_v2", "type": "functions", "configuration": {"functionName": "log", "script": "'version 2'"}}]
		}
	}`
...
func TestRuntime_AOP(t *testing.T) {
	...
	msg := types.NewMsg("TEST_AOP", "{}", types.Metadata{}, nil).WithDataFormat(types.JSON)
...
func TestRuntime_ForkJoin(t *testing.T) {
	...
	dsl := `
	{
		"metadata": {
			"nodes": [
				...
				{"id": "fork_a", "type": "functions", "configuration": {"functionName": "log", "script": "'{\\\"log\\\":\\\"from a\\\", \\\"metadata\\\":{\\\"from\\\":\\\"a\\\"}}'"}},
				{"id": "fork_b", "type": "functions", "configuration": {"functionName": "log", "script": "'{\\\"log\\\":\\\"from b\\\", \\\"metadata\\\":{\\\"from\\\":\\\"b\\\"}}'"}},
	...
	msg := types.NewMsg("TEST_FORK_JOIN", "{}", types.Metadata{}, nil).WithDataFormat(types.JSON)
