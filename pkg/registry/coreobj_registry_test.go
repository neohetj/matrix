...
import (
	...
	matrixlog "gitlab.com/neohet/matrix/internal/log"
...
func TestMain(m *testing.M) {
	...
	matrixlog.SetLogger(&test_utils.TestLogger{})
	os.Exit(m.Run())
}
...
func TestDefaultCoreObjRegistry_Register(t *testing.T) {
	t.Run("should register valid defs", func(t *testing.T) {
		...
		def1 := types.NewCoreObjDef(&struct{}{}, "TestObjectV1_0", "desc")
	...
	t.Run("should not log warning for compliant SID", func(t *testing.T) {
		...
		registry := NewCoreObjRegistry()
		def1 := types.NewCoreObjDef(&struct{}{}, "GoodSidV1_0", "desc")
		registry.Register(def1)
