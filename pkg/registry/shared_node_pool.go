...
func (p *nodePool) GetInstance(id string) (interface{}, error) {
	ctx, ok := p.Get(id)
	if !ok {
...
func (m *minimalNodeCtx) ChainConfig() types.Config                { return nil }
...
func (m *minimalNodeCtx) GetNodeById(id string) bool               { return false }
...
func (m *minimalNodeCtx) Config() types.Config { return m.nodeDef.Configuration }
